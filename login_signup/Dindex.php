                                    ...
                                    <div class="card-body py-4">
                                        <div class="d-flex align-items-start">
                                            <div class="flex-grow-1">
                                                <h2 class="mb-2 ml-4 p-2 text-black"><span>21</span></h2>
                                                <div class="mb-0 d-flex align-items-center">
                                                    <i class="fa-solid fa-clock me-2" style="color: black"></i>
                                                    <p class="mb-0 text-black">New Bookings</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card bg-white border-0 shadow">
                                    <div class="card-body py-4">
                                        <div class="d-flex align-items-start">
                                            <div class="flex-grow-1">
                                                <h2 class="mb-2 ml-4 p-2 text-black"><span>38</span></h2>
                                                <div class="mb-0 d-flex align-items-center">
                                                    <i class="fa-solid fa-clock me-2 text-primary"></i>
                                                    <p class="mb-0 text-primary">Total Number of Bookings</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card bg-white border-0 shadow">
                                    <div class="card-body py-4">
                                        <div class="d-flex align-items-start">
                                            <div class="flex-grow-1">
                                                <h2 class="mb-2 ml-4 p-2 text-black"><span>17</span></h2>
                                                <div class="mb-0 d-flex align-items-center">
                                                    <i class="fa-solid fa-circle-check me-2" style="color: green"></i>
                                                    <p class="mb-0 text-success">Completed Bookings</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
